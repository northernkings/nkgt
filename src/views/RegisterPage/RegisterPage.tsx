    ...
    <>
      {step === 1 && (
        ...
        >
          ...
          <p>
            If you're planning on registering for multiple attendees, please complete a registration
            for each player individually.
          </p>
          <p>
            Tickets are priced at <strong>&pound;60</strong>, include a proper lunch on both days
            and a planned evening social.
          </p>
          ...
          >
            ...
            <div className="c-form__group">
              ...
              <p>
                <small>
                  Note: We will endevour to keep teams apart for game one, but we cannot guarantee
                  this.
                </small>
              </p>
              <input
      ...
      {step === 2 && (
        ...
        >
          ...
          <p>
            <small>Note: Any registration without a matching payment will be disregarded.</small>
          </p>
        </EditorialSection>
      )}
