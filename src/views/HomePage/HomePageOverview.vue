<template>
  <EditorialSection title="Devastation, carnage and slaughter awaits" :variants="['reverse:sm']">
    ...
    <p>
      The Northern Kings GT is a five game, 2300 point Kings of War event, held over two days (21st
      and 22nd June 2025) at The Ossett War Memorial Community Centre, Wakefield.
    </p>
    <p>
